  ...
  return (
    <React.Fragment>
      <div className="TermsTw">
        <h3>一、會員服務條款</h3>
        <div className="ml-3">1.本會員服務條款所稱之「會員」，為依照本站所定之加入會員程序加入完成並通過認證者。</div>
        <div className="ml-3">2.當您使用本站服務時，即表示您同意及遵守本服務條款的規定事項及相關法律之規定。</div>
        <div className="ml-3">3.本站保留有審核加入會員資格之權利，另外已加入會員者，本站亦保留有解除其會員資格之權利。</div>
        <div className="ml-3">4.本會員服務條款之修訂，適用於所有會員，當本站修訂本服務條款時，將於本站上公告。</div>

        <h3>二、隱私權保護</h3>
        <div className="ml-3">尊重並依據本網站「隱私權保護聲明」保護您的隱私(請參閱「隱私權保護聲明」條款)。</div>
        <h3>三、會員</h3>
        <div className="ml-3">1.使用本站所提供之會員服務時，於加入會員時所登錄之帳號及密碼使用之。</div>
        <div className="ml-3">
        ...
        <div className="ml-3">4.每次結束使用本服務，執行會員之登出並關閉視窗，以確保您的會員權益。</div>
        <div className="ml-3">
          5.盜用第三者會員之帳號及密碼，導致第三者或本公司遭其他第三人或行政機關之調查或追訴時，第三者會員或本公司有權向您請求損害賠償，包括但不限於訴訟費用、律師費及商譽損失等。
        </div>

        <h3>四、會員登錄資料</h3>
        <div className="ml-3">1.會員登錄資料須提供您本人正確、最新及完整的資料。</div>
        <div className="ml-3">
        ...
        <h3>五、使用行為</h3>
        <div className="ml-3">1.您使用本服務之一切行為必須符合當地或國際相關法令規範；對於使用者的一切行為，您須自行負擔全部責任。</div>
        <div className="ml-3">
          2.您同意絕不為非法之目的或以非法方式使用本服務，與確實遵守中華民國相關法規及網際網路之國際慣例，並保證不得利用本服務從事侵害他人權益或違法之行為。
        </div>
        <div className="ml-3">3.您於使用本站會員服務時應遵守以下限制：</div>
        <div className="ml-5">a)有損他人人格或商標權、著作權等智慧財產權或其他權利內容。</div>
        <div className="ml-5">b)使用違反公共秩序或善良風俗或其他不法之文字。</div>
        <div className="ml-5">c)強烈政治、宗教色彩的偏激言論。</div>
        <div className="ml-5">
          d)未經本公司許可，不得利用本服務或本網站所提供其他資源，包括但不限於圖文資料庫、編寫製作網頁之軟體等，從事任何商業交易行為，或招攬廣告商或贊助人。
        </div>
        <div className="ml-5">e)其他違反本站「會員服務條款」的內容。</div>
        ...
        <h3>八、免責事項</h3>
        <div className="ml-3">1.下列情形發生時，本網站有權可以停止、中斷提供本服務：</div>
        <div className="ml-5">a)對本服務相關軟硬體設備進行更換、升級、保養或施工時。</div>
        <div className="ml-5">b)發生突發性之電子通信設備故障時。</div>
        <div className="ml-5">c)天災或其他不可抗力之因素致使本網站無法提供服務時。</div>
        <div className="ml-3">
        ...
        <div className="ml-3">6.本公司無須對發生於本服務或透過本服務所涉及之任何恐嚇、誹謗、淫穢或其他一切不法行為對您或任何人負責。</div>
        <div className="ml-3">
        ...
        <div className="ml-3">2.本公司有權暫時或永久修改或中止提供本服務給您，您不得因此要求任何賠償。</div>
        ...
        <h3>十一、其他規定</h3>
        <div className="ml-3">1.本網站使用者條約，免責之內容，亦構成本使用條款之一部分。</div>
        <div className="ml-3">2.凡因使用本服務所生之爭執，均以台灣臺中地方法院為第一審管轄法院。</div>
        <div className="ml-3">
        ...
        <h3>十二、會員身份終止與本公司通知之義務：</h3>
        <div className="ml-3">1.本公司具有更改各項服務內容或終止任一會員帳戶服務之權利。</div>
        <div className="ml-3">
