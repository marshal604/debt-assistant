...
const PrivacyEn: FunctionComponent = props => (
  <React.Fragment>
    ...
    <ul>
      ...
      <li>
        <p>
          <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Debt Assistant.
        </p>
      </li>
      <li>
        ...
        means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or
      ...
      <li>
        <strong>Website</strong> refers to Debt Assistant, accessible from https://marshal604.github.io/debt-assistant
      </li>
      <li>
    ...
    <p>
      ...
      offline, while Session Cookies are deleted as soon as You close your web browser. Learn more about cookies in the
    ...
    <ul>
      ...
      <li>
        ...
        through a Third-Party Social Media Service, Your contacts on the Third-Party Social Media Service may see You name, profile,
    ...
    <ul>
      <li>By email: marshal604@gmail.com</li>
    </ul>
  </React.Fragment>
);
